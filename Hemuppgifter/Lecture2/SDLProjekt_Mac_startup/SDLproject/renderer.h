...
typedef struct {
    int outputWidth, outputHeight;      // size of object when being rendered to the screen
...
void closeRenderer();                                   // deallocate resources (should be called on exit)
...
// Render text to screen at position x,y
